...
<?php if(logged_in()){
  redirect("index.php"); # logged in user can not access this page
} ?>
    <div class="row">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form id="register-form"  method="post"  role="form" autocomplete="off">
										...
										<input type="hidden" class="hide" name="token_recover" id="token_recover" value="<?php echo token_generator();?>" >
